...
//		robot.intake.readTuningValuesFromDashboard();
    ...
    public void periodic(double deltaTime) {
        ...
        if (ps4.isDown(PS4.Button.LEFT_BUMPER)) {
            ...
            else if (ps4.isPressed(PS4.Button.DPAD_LEFT)) setDriveMode(DriveMode.DANCE);
        }
        ...
        switch (driveMode) {
            case GRILLED_CHEESE:
                ...
                break;
            case PURE_CHEESE:
                if (ps4.isDown(PS4.Button.RIGHT_BUMPER))
            ...
            case TANK:
                ...
                break;
            case MARIO_KART:
                if (ps4.isDown(PS4.Button.LEFT_TRIGGER_BUTTON))
                    robot.driveBase.driveArcade(ps4.getAxis(PS4.Axis.TILT_PITCH), Utilities.expInput(ps4.getAxis(PS4.Axis.TILT_ROLL), 2));
                else robot.driveBase.driveTank(0, 0);
                break;
            case DANCE:
                if (ps4.isDown(PS4.Button.LEFT_TRIGGER_BUTTON))
                    robot.driveBase.driveArcade(dance.getAxis(Dancepad.Axis.VERTICAL), dance.getAxis(Dancepad.Axis.HORIZONTAL));
                else robot.driveBase.driveTank(0, 0);
                break;
            case STOP:
