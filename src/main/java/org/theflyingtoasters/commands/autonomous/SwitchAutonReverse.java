 ...
 *
 */
public class SwitchAutonReverse extends OpMode {
	...
	public SwitchAutonReverse(Robot bot, String gameData) {
		...
		motionProfileCmd = new MotionProfileCommand(this, robot, "drive to switch", true, MotionProfileCommand.Speed.MED_LOW_ACCEL, start, end);
