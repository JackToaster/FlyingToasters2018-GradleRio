...
public abstract class Utilities {
	...
	public interface Conversions extends Constants.Measurments {
		...
		enum Velocity{
			 ...
			 */
			public double convert(double velocity, Velocity v2) {
				return velocity * v2.velocity / this.velocity;
			}
		}
		...
		enum Angle{
			 ...
			 * @return the converted measurement
			 */
			public double convert(double angle, Angle a2) {
				return angle * a2.angle / this.angle;
			}
		}
	}
